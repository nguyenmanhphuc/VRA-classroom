...
Search_overview.html - HTML overview documentation file for the generated component. It 
                       contains the requirements for accessing the component and for 
                       generating arguments using the MWArray class hierarchy.

Search.xml - This file contains the code comments for the Search component classes and 
                       ...
                       online documentation for the Search component.
